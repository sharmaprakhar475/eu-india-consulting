...
<section id="services" class="services service-section">
  ...
  <div class="section-header">
    ...
    <p style="padding-bottom: 30px;text-align: left;">We are offering Master Programs in German as the medium of instruction whereby we support the students with the admission process to the MA program as well to the DSH-Preparation.</p>
      ...
      <div class="col-md-4 col-sm-4 services text-center"> 
        <div class="services-content pl-0" style="text-align: left;">
          ...
          <ol> 
                    ...
                    <li class="pb-0">SOFTWARE LOCALIZATION</li>
                    <li class="pb-0">DATA SCIENCE </li>
                    <li class="pb-0">DIGITAL MEDIA TECHNOLOGIES</li>
                    <li class="pb-0">INTERACTIVE MEDIA</li>
          </ol>
        </div>
      </div>
      <div class="col-md-4 col-sm-4 services text-center">
        <div class="services-content pl-0" style="text-align: left;" >
          <h5>ARCHITECTURE/DESIGN</h5>
            <ol>
                    ...
                    <li class="pb-0">MONUMENT PRESERVATION MANAGEMENT</li>
                    <li class="pb-0">LANDSCAPE ARCHITECTURE AND ENVIRONMENTAL PLANNING</li>
                    <li class="pb-0">INTERMEDIA DESIGN</li>
            </ol>          
        </div>
      </div>
</div >
