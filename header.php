<section class="banner" role="banner"  >
  <header id="header">
    <div class="header-content clearfix" > <a class="logo" href="index.html"><img src="images/logo/logo.png" width="150px" style="padding-top:5px;"></a>
  ...
  <!-- banner text --> 
    ...
    <div class="euindia-banner"><img src="./images/slides/3.jpg"></div>
